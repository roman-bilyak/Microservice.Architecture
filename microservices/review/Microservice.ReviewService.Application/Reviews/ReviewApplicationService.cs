...
internal class ReviewApplicationService : ApplicationService, IReviewApplicationService
{
    ...
    public async Task<ReviewDto> GetAsync([Required] Guid id, CancellationToken cancellationToken)
    {
    ...
    public async Task<ReviewDto> CreateAsync(CreateReviewDto review, CancellationToken cancellationToken)
    {
