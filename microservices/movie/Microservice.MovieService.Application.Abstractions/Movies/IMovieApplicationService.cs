...
public interface IMovieApplicationService : IApplicationService
{
    ...
    public Task<MovieListDto> GetListAsync(int pageIndex, int pageSize, CancellationToken cancellationToken);
    ...
    public Task<MovieDto> GetAsync(Guid movieId, CancellationToken cancellationToken);
    ...
    public Task<MovieDto> CreateAsync(CreateMovieDto movie, CancellationToken cancellationToken);
    ...
    public Task<MovieDto> UpdateAsync(Guid movieId, UpdateMovieDto movie, CancellationToken cancellationToken);
    ...
    /// <param name="cancellationToken">A cancellation token that can be used to cancel the operation.</param>
    public Task DeleteAsync(Guid movieId, CancellationToken cancellationToken);
}
